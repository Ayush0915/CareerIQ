...
# SlowAPIMiddleware MUST be added before CORSMiddleware so rate-limit
# rejection happens before CORS headers are added, and — critically —
# before a StreamingResponse generator is started.  This ensures the
# 429 is returned synchronously even on the SSE /analyze route.
